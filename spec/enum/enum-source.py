...
class EnumType(type):
    ...
    def __new__(metacls, cls, bases, classdict, *, boundary=None, _simple=False, **kwds):
        ...
        # class will fail).
        #
        print(f'1.1 new({cls}, bases, classdict)',)
        if cls in ('JobStatus'):
            print('1.1.1 ', classdict, classdict._member_names)
        if _simple:
